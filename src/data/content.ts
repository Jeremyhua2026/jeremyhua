  ...
  proof: {
    ...
    stories: [
      ...
      },
      {
        ...
        closer: "Tight loops teach faster than theory.",
        stat: "7M+",
    ...
    items: [
      {
        ...
        description: "Drop in a CSV from any major bank. See the gap between what you think you spend and what you actually spend.",
        status: "Live",
        tags: ["Personal finance", "Behavior"],
        href: "/projects/finance-reality-check/",
      },
      {
        id: "portfolio-risk",
        title: "Portfolio Risk",
        description: "Multi-brokerage CSV in, calibrated risk read out. Not a personality quiz, your actual exposure.",
        status: "Live",
        tags: ["Investing", "Decision tools"],
        href: "/projects/portfolio-risk/",
      },
      {
        id: "youtube-insight",
        title: "YouTube → Insight",
        description: "FastAPI + Gemini. Pulls a transcript, returns a personalized analysis and a short script worth sharing. Local-only. Clone the repo, bring your own Gemini key.",
        status: "Personal tool",
        tags: ["FastAPI", "LLM", "Python"],
        href: "https://github.com/Jeremyhua2026/youtube-content-reviewer",
      },
    ],
  },
